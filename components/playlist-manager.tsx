  ...
  return <section className="studio-shell account-shell" aria-labelledby="playlist-library-title">
      <div className="playlist-library">
        ...
        <div className="library-grid">
          ...
          <PlaylistEditor inputMode={manager.inputMode} isSaving={manager.isSaving} isValid={manager.isValid} items={manager.items} name={manager.name} onAddItem={manager.addItem} onAddUploadedItem={manager.addUploadedItem} onChangeMode={manager.changeInputMode} onDelete={() => manager.selected && manager.setDeleteTarget(manager.selected)} onDuplicateItem={manager.duplicateItem} onMoveItem={manager.moveItem} onNameChange={manager.setName} onRemoveItem={manager.removeItem} onReorderItems={manager.reorderItems} onSave={() => void manager.save()} onSimpleInputChange={manager.setSimpleInput} onUpdateItem={manager.updateItem} selected={manager.selected} simpleInput={manager.simpleInput} />
        </div>
        <AudioLibrary files={audioLibrary.files} isLoading={audioLibrary.isLoading} maxBytes={audioLibrary.maxBytes} maxFiles={audioLibrary.maxFiles} onDelete={audioLibrary.setDeleteTarget} totalBytes={audioLibrary.totalBytes} />
